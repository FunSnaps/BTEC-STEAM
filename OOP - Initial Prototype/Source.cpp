...
//	u1->library.addAtEnd(new LibraryItem("2018-06-18", app.GetStore().games[1]));
//	u2->library.addInFront( new LibraryItem("2018-09-19", app.GetStore().games[2]));
//	u2->library.addAtEnd(new LibraryItem("2018-09-19", app.GetStore().games[3]));
//	u3->library.addInFront(new LibraryItem("2018-09-24", app.GetStore().games[3]));
//	u3->library.addAtEnd( new LibraryItem("2018-09-30", app.GetStore().games[6]));
//
